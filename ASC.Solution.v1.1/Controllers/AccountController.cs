...
using ASC.Solution.v1._1.Controllers;
using Microsoft.AspNetCore.Authentication;
using ASC.Solution.Models.AccountViewModels;
using ASC.Solution.v1._1.Models;
using ASC.Utilities;
using ASC.Models.BaseTypes;
using ASC.Solution.v1._1.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var isActive = Boolean.Parse(claims.Result.FirstOrDefault(x => x.Type == "IsActive").Value);
